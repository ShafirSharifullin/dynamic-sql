...
VALUES (Default, 'Byron Ferguson', 'freelance_emp', 120000, 2000,
        (select c.id from companies c where c.name = 'IT TECH'));
INSERT INTO "employees"
VALUES (Default, 'Jose Green', 'full_time_emp', 130000, 1991, (select c.id from companies c where c.name = 'IT TECH'));
INSERT INTO "employees"
VALUES (Default, 'John Delgado', 'full_time_emp', 50000, 1979, (select c.id from companies c where c.name = 'IT TECH'));
INSERT INTO "employees"
...
INSERT INTO "employees"
VALUES (Default, 'Brandon James', 'full_time_emp', 77000, 1999, (select c.id from companies c where c.name = 'IT NET'));
INSERT INTO "employees"
...
VALUES (Default, 'Albert Jenkins', 'freelance_emp', 140000, 1982,
        (select c.id from companies c where c.name = 'IT NET'));
INSERT INTO "employees"
VALUES (Default, 'Bruce Myers', 'freelance_emp', 90000, 1980, (select c.id from companies c where c.name = 'IT NET'));
INSERT INTO "employees"
...
INSERT INTO "employees"
VALUES (Default, 'John Woods', 'freelance_emp', 177000, 1998, (select c.id from companies c where c.name = 'ITois'));
INSERT INTO "employees"
VALUES (Default, 'Richard Montgomery', 'freelance_emp', 134000, 1983,
        (select c.id from companies c where c.name = 'ITois'));
INSERT INTO "employees"
VALUES (Default, 'Arthur Brock', 'full_time_emp', 200000, 1976, (select c.id from companies c where c.name = 'ITois'));
INSERT INTO "employees"
VALUES (Default, 'Jay Foster', 'full_time_emp', 254000, 1975, (select c.id from companies c where c.name = 'ITois'));
INSERT INTO "employees"
VALUES (Default, 'Louis Horton', 'full_time_emp', 76000, 2000, (select c.id from companies c where c.name = 'ITois'));
INSERT INTO "employees"
