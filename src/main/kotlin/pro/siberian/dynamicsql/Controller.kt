...
class Controller(
    ...
    fun getEmployees(
        @RequestParam("has_full_time_emp") hasFullTimeEmp: Boolean,
        @RequestParam("has_freelance_emp") hasFreelanceEmp: Boolean,
    ): List<Employee> {
        return employeeServ.findAll(hasFullTimeEmp, hasFreelanceEmp)
    }
